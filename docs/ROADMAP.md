# Memorial 3D Studio roadmap

## Gate 0 — technical vertical slice
- Parametric stele geometry.
- Granite, glass and hybrid material modes.
- Client-side portrait preview: color / B&W.
- Plot, plinth, flower bed, paving, fence, bench, table and vase placeholders.
- Versioned project schema and local persistence.
- JSON project export.
...
- Lead submission with project configuration and render.
- CRM/API integration.
- Analytics funnel and A/B tests.

## Post-MVP
- Pricing/BOM engine.
- AR.
- Natural-language configuration over approved catalog components.
