...
test('share URL round-trips paired current project configuration', () => {
  ...
  project.steles[0].monument.depthM = 0.016
  project.steles[0].glass.thicknessMm = 16
  project.steles[0].glass.mountType = 'manet'
  project.steles[0].glass.uvPrintSides = 2
  project.steles[0].glass.printEdgeMarginMm = 14
